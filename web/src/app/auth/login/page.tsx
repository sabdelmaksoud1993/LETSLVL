      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-lvl-carbon rounded-2xl p-8 border border-lvl-slate/30">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-right">
              <Link
                ...
                className="text-sm text-lvl-yellow hover:underline font-body"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="flex items-center justify-center gap-2 border border-lvl-slate rounded-lg py-3 text-lvl-white font-body text-sm hover:border-lvl-smoke transition-colors"
            >
