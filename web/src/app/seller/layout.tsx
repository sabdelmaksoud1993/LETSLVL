  ...
  return (
    <div className="min-h-screen bg-lvl-black flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        <div className="mx-auto w-16 h-16 rounded-full bg-lvl-yellow/10 flex items-center justify-center mb-6">
          <Store className="w-8 h-8 text-lvl-yellow" />
        </div>
        <h1 className="font-display text-3xl font-bold text-lvl-white mb-3">
          Become a Seller
        </h1>
        <p className="font-body text-lvl-smoke mb-6">
          Want to sell on LET&apos;S LVL? Apply to become a verified seller and
          start reaching thousands of buyers across the MENA region.
        </p>
        <Link
          href="/"
  ...
  return (
    <div className="min-h-screen bg-lvl-black flex items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="font-body text-lvl-smoke text-sm">Loading seller panel...</p>
      </div>
    </div>
  );
}
    ...
    <div className="min-h-screen bg-lvl-black flex">
      ...
      >
        ...
        <div className="px-3 py-2">
          <Link
            href="/"
            className="flex items-center gap-2 px-3 py-2 text-sm font-body text-lvl-smoke hover:text-lvl-white hover:bg-lvl-slate/30 rounded-lg transition-colors"
          >
        ...
        <div className="px-3 py-4 border-t border-lvl-slate/30 space-y-2">
          <div className="flex items-center gap-3 px-3 py-2">
            <div className="w-8 h-8 rounded-full bg-lvl-yellow flex items-center justify-center text-xs font-body font-bold text-lvl-black">
